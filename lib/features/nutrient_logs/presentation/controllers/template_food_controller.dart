...
part 'template_food_controller.g.dart';

@riverpod
class TemplateFoodSearchQuery extends _$TemplateFoodSearchQuery {
  Timer? _timer;
...
@riverpod
class TemplateFoodController extends _$TemplateFoodController {
  bool _isFetchingMore = false;

  @override
  FutureOr<FoodListState?> build() async {
    final query = ref.watch(templateFoodSearchQueryProvider);
  ...
  Future<void> loadNextPage() async {
    ...
    state = await AsyncValue.guard(() async {
      final query = ref.read(templateFoodSearchQueryProvider);
      if (!ref.mounted) return null;
